      ...
      <div className=' w-full h-auto  md:h-screen bg-gray-100 flex justify-center flex-col items-center px-3 py-2'>
        ...
        Data.ProductDetails.map((item,i)=>{
              return(item.subcetegory===useP?
                      ...
                      <div className=' w-full  max-[640px]:h-auto  sm:h-5/6 md:h-3/6 lg:h-2/6 xl:h-96 xl:w-4/6    sm:w-5/6 lg:w-5/6    bg-white    sm:flex sm:flex-row justify-evenly items-center shadow-xl ' key={item.id} >
       ...
       {
        ceteData?<>
        <div className=' w-full h-full sm;h-1/6 md:h-1/6 lg:h-1/6 sm:w-5/6  lg:w-5/6  xl:h-40 xl:w-4/6  mt-1 bg-white  shadow-2xl  flex justify-evenly items-center flex-row  flex-wrap pt-1  md:mt-1 '>
